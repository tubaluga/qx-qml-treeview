...
class QxQuickTreeModelAdaptor : public QAbstractListModel {
    Q_OBJECT
...
public:
    explicit QxQuickTreeModelAdaptor(QObject *parent = 0);
    ...
    Q_INVOKABLE QModelIndex mapRowToModelIndex(int row, int column = 0) const;
